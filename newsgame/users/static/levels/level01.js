...
grid = [
  ...
  [    's',    's',   's',     's',    3,    3,  'a4','b10','ti','b7','b8','b9','a3',  3,   's',    's',   's',   's',    's',    's'],
  [    's',    's',   's',     3, 'a4', 'tt',  'b10','ti','ti','b9','b10','ti','b9','tt','a3',   3,   's',   's',    's',    's'],
  [    's',    's',   's',     3, 'b4', 'ti',  'ti','ti','ti','ti','ti','ti','ti','ti','b3',   3,   's',   's',    's',    's'],
  [    's',    's',     3,  'a4', 'b10', 'ti',  'ti','ti','ti','ti','ti','ti','ti','ti','b9', 'a3',  3,   's',    's',    's'],
  [    's',      3,  'a4',  'b10', 'ti', 'ti',  'ti','ti','b7','b8','ti','ti','ti','ti', 7, 'b9','a3',  3,'s',    's'],
  [    's',      3,  'tll',  'b3', 'b4', 'ti',  'ti','ti','b9','b10','ti','ti','ti',7,'log', 7,'trr',  3,    's',    's'],
  [    's',      3,  'tll',  'ti', 'ti', 'ti',  'ti','ti','ti','ti','ti','ti','ti','ti', 7, 'ti','trr',  3,    's',    's'],
  [    's',      3,  'tll',  'ti', 'ti', 5,  6,'ti','ti','ti','ti','ti','ti','ti','ti', 'ti','trr',  3,    's',    's'],
  [    's',      3,  'a1',  'b8',  5, 'log', 'log', 6,'ti','ti','ti','ti','b7','b8','ti', 'b7','a2',  3,    's',    's'],
  [    's',      3,   3,  'a1', 'b8', 5,  6,'ti','b7','b8','ti','ti','b9','b10','b7', 'a2',  3,   's',    's',    's'],
